  ...
  parseOpen: function parseOpen(node) {
    ...
    switch (node.name) {
      case this.tag:
        this.model = {
          header: {
            odd: { raw: this.map.oddHeader.model },
            even: this.map.evenHeader.model ? { raw: this.map.evenHeader.model } : {},
            first: this.map.firstHeader.model ? { raw: this.map.firstHeader.model } : {}
          },
          footer: {
            odd: { raw: this.map.oddFooter.model },
            even: this.map.evenHeader.model ? { raw: this.map.evenFooter.model } : {},
            first: this.map.firstHeader.model ? { raw: this.map.firstFooter.model } : {}
          }
        };
        return true;
      default:
