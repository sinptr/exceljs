...
utils.inherits(WorkSheetXform, BaseXform, {
  ...
  render: function(xmlStream, model) {
    ...
    var headerFooterModel = model.pageSetup && model.pageSetup.headerFooter;
  ...
  parseClose: function(name) {
    ...
    switch (name) {
      case 'worksheet':
        ...
        if (this.map.headerFooter.model && (this.map.headerFooter.model.header.odd || this.map.headerFooter.model.footer.odd)) {
